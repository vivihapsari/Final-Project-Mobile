...
<MobileElementEntity>
   ...
   <name>TView_Account Name M Fachri</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'M Fachri' or . = 'M Fachri') and @resource-id = 'com.example.mikebanks.bankscorpfinancial:id/txt_account_name']</locator>
